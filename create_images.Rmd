...
```{r read_data}
individual_giving <- read_csv("output_data/individual_giving.csv")
...
png("Charitable Giving_percent_donating.png.png", 3000, 2400, res = 200)
...
png("Charitable Giving_percent_donated_agi7.png.png", 3000, 2400, res = 200)
ranking(filter(individual_giving, agi == 7),
        giving_pct_income, 
        plot_title = "Percent of Income Donated",
        subtitle_text = "AGI over $200,000",
...
png("Charitable Giving_percent_donated_agi72.png.png", 3000, 2400, res = 200)
ranking(filter(individual_giving, agi == 7),
        giving_pct_agi, 
